...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddJsonFormatFeatures(this IServiceCollection services)
    {
        services.AddSingleton<JsonFormatProvider>()
            .AddSingleton<IFormatProvider<IFormat>>(sp => sp.GetRequiredService<JsonFormatProvider>())
            .AddSingleton<IFormatProvider<JsonFormat>>(sp => sp.GetRequiredService<JsonFormatProvider>());
