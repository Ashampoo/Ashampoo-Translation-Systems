using Ashampoo.Translations.Formats;
using Ashampoo.Translations.Formats.Abstractions;
using Ashampoo.Translations.Formats.Abstractions.Translation;
using Ashampoo.Translations.Tools.ComponentLibrary.Services;
using Microsoft.AspNetCore.Components;

namespace Ashampoo.Translations.Tools.ComponentLibrary.Components;
