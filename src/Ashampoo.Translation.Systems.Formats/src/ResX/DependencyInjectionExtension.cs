...
public static class DependencyInjection
{
    ...
    /// </exception>
    public static IServiceCollection AddResXFormatFeatures(this IServiceCollection services)
    {
        services.AddSingleton<ResXFormatProvider>()
            .AddSingleton<IFormatProvider<IFormat>>(sp => sp.GetRequiredService<ResXFormatProvider>())
            .AddSingleton<IFormatProvider<ResXFormat>>(sp => sp.GetRequiredService<ResXFormatProvider>());
